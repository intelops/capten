...
type CaptenConfig struct {
	CaptenClusterValues
	CaptenClusterHost
	VaultCredHostName              string   `envconfig:"VAULTCRED_HOST_NAME" default:"vault-cred"`
	...
	AgentDNSNamePrefixes           []string `envconfig:"AGENT_DNS_NAME_PREFIX" default:"*,vault-cred,agent"`
